class SidebarComponent extends HTMLElement {
  ...
  connectedCallback() {
    this.innerHTML = ` <aside
      id="sidebar"
      class="fixed inset-0 z-50 grid -translate-x-full grid-cols-3 bg-transparent duration-300"
    >
      <section class="col-span-2 bg-white pl-3 pt-5">
        <!-- ? -----  (1) Logo ----- -->
        ...
        <!-- ? ----- (2) UL -->
        <ul class="mt-8 grid gap-2 pr-3 text-xl font-semibold">
          <li
            id="sidebarCompanyDropdown"
            class="h-10 overflow-hidden duration-300"
          >
            <div
              id="sidebarCompanyDropdownActivator"
              class="grid grid-flow-col items-center justify-between"
            >
              Company
              <svg
                xmlns="http://www.w3.org/2000/svg"
                id="sidebarCompanyDropdownSvg"
                class="w-4 rotate-90 fill-red stroke-red stroke-2 duration-300"
                viewBox="0 0 24 24"
              >
                <path
            ...
            <div class="grid pt-4 text-base">
              <a href="./about.html" class="py-2 duration-300 hover:text-red"
                >About Life9 Systems</a
              >
              <a href="./careers.html" class="py-2 duration-300 hover:text-red"
                >Careers</a
              >
              <a
                href="./contactus.html"
                class="py-2 duration-300 hover:text-red"
                >Contact Us</a
              >
            </div>
          </li>
          <li
          class="h-10 overflow-hidden duration-300"
            id="sidebarProductsDropdown"
          >
          <div
          id="sidebarProductsDropdownActivator"
          class="grid grid-flow-col items-center justify-between"
        >
          Products
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="sidebarProductsDropdownSvg"
            class="w-4 rotate-90 fill-red stroke-red stroke-2 duration-300"
            viewBox="0 0 24 24"
          >
            <path
        ...
        <div class="grid pt-4 text-base opacity-60">
          Coming Soon
        </div>
          </li>
          <li
          class="h-10 overflow-hidden duration-300"
            id="sidebarSolutionsDropdown"
          >
          <div
          id="sidebarSolutionsDropdownActivator"
          class="grid grid-flow-col items-center justify-between"
        >
          Solutions
          <svg
            xmlns="http://www.w3.org/2000/svg"
            id="sidebarSolutionsDropdownSvg"
            class="w-4 rotate-90 fill-red stroke-red stroke-2 duration-300"
            viewBox="0 0 24 24"
          >
            <path
        ...
        <div class="grid pt-4 text-base opacity-60">
          ...
          <li
            class="grid grid-flow-col items-center justify-between py-2 opacity-20"
          >
            Case Studies
            <svg
              xmlns="http://www.w3.org/2000/svg"
              id="companyDropdownActivatorSvg"
              class="w-4 rotate-90 fill-gray-400 stroke-gray-400 stroke-2 duration-300"
              viewBox="0 0 24 24"
            >
              <path
                d="m8.006 21.308l-1.064-1.064L15.187 12L6.942 3.756l1.064-1.064L17.313 12z"
          ...
          <li class="grid place-items-center py-4 text-base">
            <a
              href="./contactus.html"
              class="rounded-full w-full text-center bg-red px-6 py-3 text-white"
              >Get in touch</a
            >
          </li>
        </ul>
      </section>
      <section id="closeSidebar"></section>
    </aside>`;
  }
}
